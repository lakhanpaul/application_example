defmodule DungeonCrawl.Battle do
  ...
  def fight(char_a = %{hit_points: hit_points_a}, char_b = %{hit_points: hit_points_b}) when hit_points_a == 0 do
    {char_a, char_b}
  end

  def fight(char_a = %{hit_points: hit_points_a}, char_b = %{hit_points: hit_points_b}) when hit_points_b == 0 do
    character_after_score_increase = Character.increase_score(char_a, 5)
    {character_after_score_increase, char_b}
  end
